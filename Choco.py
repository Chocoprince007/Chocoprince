...
\033[1;96m................\033[1;93mChocoprince\033[1;91m...............
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Chocoprince Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' Chocoprince WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Chocoprince')

	    os.system('cd $HOME && git clone https://github.com/Chocoprince007/Chocoprince.git')
	    ...
	    psb('WellCome To Chocoprince')

	    psb('Congratulations Chocoprince Tool Has Been Updated Successfully')
	    ...
	    os.system('cd $HOME/Chocoprince && python2 Choco.py')
